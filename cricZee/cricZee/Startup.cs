...
namespace cricZee
{
    public class Startup
    {
...

        {
            ...
            services.AddDbContext<TejaContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:matchconstr"]));
            services.AddDbContext<dbContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:signconstr"]));
